      ...
      <div className="container">
        ...
        <div className="why-grid">
          ...
          <div className="why-card">
            ...
            <p>Pay securely and quickly using any UPI app before delivery.</p>
          </div>
          ...
          <div className="why-card">
            ...
            <p>We sell trusted brands with quality you can rely on.</p>
          </div>
          ...
          <div className="why-card">
            ...
            <p>Need help choosing a product? Chat with us anytime.</p>
          </div>
        </div>
      </div>
    </section>
