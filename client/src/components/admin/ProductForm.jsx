...
function ProductForm({ form, handleChange, handleSubmit, isEditing, setForm }) {
  ...
  const handleDiscountAmountChange = (e) => {
    ...
    if (form.mrp && dAmount >= 0) {
      ...
      handleChange({
        target: {
          name: "price",
          value: calculatedPrice >= 0 ? calculatedPrice : 0,
        },
      });
    }
  };
    ...
    if (form.images && form.images.length > 0) {
      ...
      if (typeof form.image === "string" && form.image !== "") {
        if (
          ...
          newPreviews.push(
            `//${window.location.host}/api/images/${form.image}`,
          );
        }
      }
    }
    ...
    <div className="admin-card product-management-form">
      ...
      >
                ...
                {previews.map((src, idx) => (
                  <div
                    ...
                    style={{
                      position: "relative",
                      border:
                        idx === 0 ? "2px solid #0056b3" : "1px solid #ddd",
                      borderRadius: "8px",
                      padding: "4px",
                    }}
                  >
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                handleChange({
                  target: { name: "hasVariants", value: e.target.checked },
                })
              }
            />
                        ...
                        src={
                          typeof variant.image === "string"
                            ? variant.image.startsWith("http") ||
                              ...
                              ? variant.image
                              : `//${window.location.host}/api/images/${variant.image}`
                    ...
                    <button
                      ...
                      onClick={() =>
                        handleChange({
                          target: {
                            name: "variants",
                            value: form.variants.filter((_, i) => i !== idx),
                          },
                        })
                      }
                      style={{
          ...
          >
            ...
            >
              <input
                ...
                checked={form.allowOutOfStockPurchase}
                onChange={(e) =>
                  handleChange({
                    target: {
                      name: "allowOutOfStockPurchase",
          ...
          <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleChange({
                    target: { name: "bestSeller", value: e.target.checked },
                  })
                }
              />
              Best Seller
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleChange({
                    target: { name: "newArrival", value: e.target.checked },
                  })
                }
              />
              New Arrival
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleChange({
                    target: { name: "showOnHomepage", value: e.target.checked },
                  })
                }
              />
              Show on Homepage
        ...
        >
          <button
            type="submit"
            disabled={Number(form.price) > Number(form.mrp)}
            style={{
              flex: 1,
              padding: "12px",
              background:
                Number(form.price) > Number(form.mrp) ? "#ccc" : "#0056b3",
              color: "white",
              border: "none",
              borderRadius: "5px",
              cursor:
