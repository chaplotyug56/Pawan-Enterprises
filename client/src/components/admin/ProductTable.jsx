...
function ProductTable({ products, editProduct, deleteProduct, updateStock }) {
  ...
  const getStatus = (product) => {
    ...
    if (totalStock === 0) {
      return (
        <span className="badge danger" style={{ background: "#dc3545" }}>
          Out of Stock
        </span>
      );
    ...
    return (
      <span className="badge success" style={{ background: "#28a745" }}>
        In Stock
      </span>
    );
  };
                    ...
                    <img
                      ...
                      src={
                        ...
                        product.image?.startsWith("//")
                          ? product.image
                          : `//${window.location.host}/api/images/${product.image}`
                      }
                      alt={product.name}
                      style={{
                        width: "50px",
