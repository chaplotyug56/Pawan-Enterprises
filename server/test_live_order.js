...
async function test() {
  try {
    ...
    form.append('items', JSON.stringify([{ product: '66bc6f7bc22af50e0474ce24', quantity: 1, color: '', size: '' }]));
    form.append('shippingAddress', JSON.stringify({ fullName: 'Test', phone: '1234567890', street: 'test', city: 'test', pincode: '123456' }));
    form.append('location', JSON.stringify({ latitude: 0, longitude: 0, distance: 0 }));
